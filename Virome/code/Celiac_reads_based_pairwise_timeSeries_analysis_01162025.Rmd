...
View(abundance.table.all.species)
write.csv(abundance.table.all.species,"~/Handley\ Lab\ Dropbox/16S/Celiac/Phage/phage_detection_pipeline_new_assembly/Virome/Vertebrate_viruses/data/abundance.table.all.species.csv")
